...
class Persona {
  ...
  //PUNTO 3//
  method estaPorExplotar() = emociones.all({ e => e.puedeLiberar() })
...
class Ansiedad inherits Emocion { //TODOS LA TIENEN... DE DISTINTAS MANERA//
  ...
  //NADIE QUIERE VERLA TRABAJNDO SIN SU TAZA DE TÉ... POR ESO LO COMPRAN MÁS// 
...
/*
  ...
  RESPONDER / RECONOCER los metodos que conoce toda emocion e incluir caracteristicas própias. Además, nos evita repetir codigo.
*/
